            ...
            <div className="mx-auto max-w-7xl pt-20 sm:pb-24 px-6">
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12'>
                    ...
                    <div className='col-span-7 flex flex-col justify-evenly relative'>
                        ...
                        <h1 className='text-midnightblue text-4xl md:text-85xl text-center lg:text-start font-semibold lh-133 pt-5'>Your Gateway to Secure Banking Excellence!.</h1>
                        <h3 className='text-black opacity-75 text-lg font-normal text-center lg:text-start pt-8'>Embark on a banking journey without constraints – our platform offers a seamless experience, accessible 24/7. Whether at home, work, or on the go, manage your finances effortlessly. Experience the freedom of banking anytime, anywhere with Normanstone Bank.</h3>
