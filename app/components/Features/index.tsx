...
const Aboutdata: datatype[] = [
    {
        ...
        heading: "Access Mobile Banking",
        paragraph: 'Our site is now mobile-friendly. To access mobile banking, please log in on our homepage with your Online Banking User ID and password after you have completed the enrollment process.',
    },
    {
        imgSrc: "/assets/features/signal.svg",
        heading: "Business Customer",
        paragraph: 'Mobile Banking allows you to keep up with your finances while you are on the go. You can do your normal Online Banking business, plus you can use the Mobile Authorizations feature to approve transactions initiated at the office',

    },
    {
        imgSrc: "/assets/features/dollar.svg",
        heading: "Mobile Wallet",
        paragraph: 'Let us help you experience convenience and safety in a new way while using your phone for more than selfies.',
