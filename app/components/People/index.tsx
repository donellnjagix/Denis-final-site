            ...
            <div className="mx-auto max-w-7xl px-6">
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 space-x-1 pt-10 lg:pt-32 lg:mt-20'>
                    ...
                    <div className='col-span-6 flex flex-col justify-evenly lg:pl-24 mt-10 lg:mt-0'>
                        ...
                        <h3 className='text-black text-lg font-normal text-center lg:text-start lh-173 opacity-75 pt-5 lg:pt-0'>earning and preserving your trust is our paramount commitment. Every transaction, service, and innovation revolves around safeguarding your confidence. Your trust is the bedrock of our integrity  a priority we uphold with unwavering dedication and transparency.</h3>
